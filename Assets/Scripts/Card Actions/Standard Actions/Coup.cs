...
public class Coup : PlayerAction
{
    ...
    protected override async Task Action()
    {
        ...
        if (attempt.enemyInfluenceRemoved > 0)
            country.AdjustInfluence(Player.Enemy.Faction, -attempt.enemyInfluenceRemoved);
    ...
    public class CoupAttempt
    {
        ...
        public int enemyInfluenceRemoved => (int)MathF.Min(coupValue, country.Influence(player.Enemy));
