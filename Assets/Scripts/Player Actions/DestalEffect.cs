...
namespace TwilightStruggle
{
    public class DestalEffect : PlayerAction
    {
        ...
        {
            TwilightStruggle.UI.Message.SetMessage($"De-Stalinization: Select up to {maxRelocate} influence to relocate");
            ...
            if (influenceRemoved > 0)
            {
                ...
                {
                    TwilightStruggle.UI.Message.SetMessage($"De-Stalinization: Place {influenceRemoved} more influence in any non-US controlled country");
