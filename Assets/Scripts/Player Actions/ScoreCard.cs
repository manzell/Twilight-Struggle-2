...
public class ScoreCard : PlayerAction
{
    ...
    public class ScoringAttempt
    {
        ...
        public ScoringAttempt(Continent continent, Player player, Dictionary<Continent.ControlStatus, int> scoringTable)
        {
            ...
            {
                { player, continent.countries.Where(country => country.Battleground && country.Control == player.Faction) },
                { player.Enemy, continent.countries.Where(country => country.Battleground && country.Control == player.Enemy.Faction) }
            };
