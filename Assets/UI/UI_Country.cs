...
namespace TwilightStruggle.UI
{
    public class UI_Country : SerializedMonoBehaviour, IPointerClickHandler, IHighlightable, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public event Action<Country> uiCountryClickEvent;
        ...
        void Start()
        {
            ...
            uiCountryClickEvent += c => c.Select(); 
        }
        ...
        public void Setup(Country country)
        {
            ...
            battlegroundIndicator.color = country.IsBattleground ? Color.red : Color.black;
            background.color = country.Continents.First().color;

            country.influenceChangeEvent += amount => UpdateUI(); 
        ...
        public void OnPointerClick(PointerEventData eventData) => uiCountryClickEvent.Invoke(country); 
